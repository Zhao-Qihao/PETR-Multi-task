...
from mmdet3d.structures.bbox_3d.utils import points_cam2img   # NOTE(Itachi): original: from mmdet3d.core.bbox.box_np_ops import points_cam2img
    ...
    for scene in nusc.scene:
        ...
        while has_more_frames:
            ...
            if os.getcwd() in lidar_path:
                ...
                # relative path
            if not os.path.exists(lidar_path):  # NOTE(Itachi): original: if not mmengine.is_filepath(lidar_path):
...
def _fill_trainval_infos(nusc,
    ...
    for sample in mmengine.track_iter_progress(nusc.sample):   # NOTE(Itachi): original: from mmcv import track_iter_progress(nusc.sample): 
