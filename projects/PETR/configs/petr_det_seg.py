...
custom_imports = dict(imports=['projects.PETR.petr', 'projects.PETR.datasets'], allow_failed_imports=False)
...
test_pipeline = [
    ...
    dict(
        ...
        training=False),
    dict(type='Pack3DDetAndMapInputs', shape=ida_aug_conf['final_dim'], keys=['img'])
]
...
# load_from = 'ckpt/fcos3d_vovnet_imgbackbone-remapped.pth'
load_from = '/data1/private-data/zhaoqh/PETR_work_dirs/petr_vovnet_gridmask_p4_800x320/epoch_24.pth'
# work_dir = '/data1/private-data/zhaoqh/PETR/petr_vovnet_gridmask_p4_800x320'
work_dir = '/data1/private-data/zhaoqh/PETR/petr_vovnet_gridmask_p4_800x320_resume_segmap'
resume = False
